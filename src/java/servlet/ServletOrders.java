 ...
 * @author memoriasIT
 */
@WebServlet(name = "ServletOrders", urlPatterns = {"/ServletOrders"})
public class ServletOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Customer client = this.customerFacade.findCustomerByID(Id);
        List<PurchaseOrder> orders = client.getPurchaseOrderList();
